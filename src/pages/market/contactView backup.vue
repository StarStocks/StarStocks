<template>
    ...
    <div class="container-fluid">
        <div class="desc-wrap bookmark-wrap">
            <div class="row">
                <div class="col-xl-3 box-col-6">
                    <div class="md-sidebar"><a class="btn btn-primary md-sidebar-toggle" href="javascript:void(0)"
                        ...
                        <div class="md-sidebar-aside desc-left-aside custom-scrollbar" :class="filtered ? 'open' : ''">
                            <div class="card">
                                <div class="card-body">
                                    <div class="desc-app-sidebar left-bookmark">
                                        <div class="media">
                                            <div class="media-size-desc"><img class="me-3 rounded-circle"
                                                    src="@/assets/images/user/user.png" alt=""></div>
                                            <div class="media-body">
                                                <h6 class="f-w-700">Luke Rodgers</h6>
                                                <p>Star Scouter</p>
                                            </div>
                                        </div>
                                        <ul class="nav main-menu contact-options" role="tablist">
                                            ...
                                            <li><a class="show" id="pills-organization-tab" data-bs-toggle="pill"
                                                    href="#pills-organization" role="tab" aria-controls="pills-organization"
                ...
                <div class="col-xl-9 col-md-12 box-col-12">
                    <div class="desc-right-aside bookmark-tabcontent contacts-tabs">
                        <div class="card desc-body radius-left">
                            <div class="ps-0">
                                <div class="tab-content">
                                    ...
                                    <div class="fade tab-pane"
                                        v-bind:class="(activeclass === 'pills-organization-tab') ? 'active show' : ''"
