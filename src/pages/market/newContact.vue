...
<li class="nav-item">
    <button class="badge-light-primary btn-block btn-mail w-100" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
        <vue-feather class="me-2" type="users"></vue-feather> New Celebs
    </button>
    <Teleport to="body">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLabel">Add Celeb</h3>
                        ...
                        <form class="form-bookmark needs-validation" id="bookmark-form" novalidate>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-12 mt-0">
                                    ...
                                    <input class="form-control" id="con-mail" type="desc" v-model="desc" required autocomplete="off">
                                </div>
